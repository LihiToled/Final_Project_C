...
bool second_pass_line_process(struct lex_tree lt, s_table *table, line_info line){
           ...
           lt.asm_inst_asm_dir.asm_inst.inst_name == lex_inst_mov){
            if(lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setA.oat[0] == lex_op_addr_type_label){
                ...
                if(get_from_s_table(table, lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setA.oatu[0].label) == NULL){
                    ...
                    sprintf(error,"The label %s is used but not defined",lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setA.oatu[0].label);
                    print_error_msg(&line, error);
                    return FALSE;
                }
            }
                ...
                if(get_from_s_table(table, lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setA.oatu[1].label) == NULL){
                    memset(error, 0, sizeof(error));
                    sprintf(error,"The label %s is used but not defined",lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setA.oatu[1].label);
                    print_error_msg(&line, error);
                    return FALSE;
                }
            }
            ...
            if(lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setB.oat == lex_op_addr_type_label){
                if(get_from_s_table(table, lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setB.setB_operands.oatu.label) == NULL){
                    memset(error, 0, sizeof(error));
                    sprintf(error,"The label %s is used but not defined",lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setB.setB_operands.oatu.label);
                    print_error_msg(&line, error);
                    return FALSE;
                }
            }
            ...
            if(lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setB.oat == lex_op_addr_type_label){
                ...
                if(get_from_s_table(table, lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setB.setB_operands.oatu.label) == NULL){
                    ...
                    if(get_from_s_table(table, lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setB.setB_operands.setB_param_label.oatu[0].label) == NULL){
                        memset(error, 0, sizeof(error));
                        sprintf(error,"The label %s is used but not defined",lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setB.setB_operands.setB_param_label.oatu[0].label);
                        print_error_msg(&line, error);
                        return FALSE;
                    }
                }
                    ...
                    if(get_from_s_table(table, lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setB.setB_operands.setB_param_label.oatu[1].label) == NULL){
                        memset(error, 0, sizeof(error));
                        sprintf(error,"The label %s is used but not defined",lt.asm_inst_asm_dir.asm_inst.asm_inst_sets.asm_inst_setB.setB_operands.setB_param_label.oatu[1].label);
                        print_error_msg(&line, error);
                        return FALSE;
                    }
                }
    ...
    if(lt.asm_inst_asm_dir.asm_dir.lex_union_asm_dir_option == lex_union_asm_dir_entry){
        ...
        if(entry == NULL){
            memset(error, 0, sizeof(error));
            sprintf(error,"The label %s is used but not defined",lt.asm_inst_asm_dir.asm_dir.dir.label);
            print_error_msg(&line, error);
            return FALSE;
        }
        else{
