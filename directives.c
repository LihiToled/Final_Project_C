...
/*
    This functions receives a char and encodes it to a data word.
...
/*
    This functions receives an integer and encodes it to a data word.
    @param value The integer to be encoded.
    @return The encoded data word.
*/
static data_w encode_int_12_bits(short int value);
...
static data_w encode_int_12_bits(short int value) {
    ...
    if (value < 0) {
        ...
        result.data = (1 << 11) | (complement & 0x7FF);
    } else {
        /* Set positive value to binary representation */
        result.data = value & 0x7FF;
    }
